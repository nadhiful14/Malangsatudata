...
<html>
    <head>
		...
		$levelx = $this->session->userdata('level');
		$name = $this->session->userdata('user');
		$m1 = $this->session->userdata('menu1');
		$m2 = $this->session->userdata('menu2');
		$m3 = $this->session->userdata('menu3');
		$m4 = $this->session->userdata('menu4');
		$m5 = $this->session->userdata('menu5');
		$m6 = $this->session->userdata('menu6');
		$m7 = $this->session->userdata('menu7');
		$m8 = $this->session->userdata('menu8');
		$m9 = $this->session->userdata('menu9');
		$m10 = $this->session->userdata('menu10');
		$m11 = $this->session->userdata('menu11');
		$m12 = $this->session->userdata('menu12');
		$m13 = $this->session->userdata('menu13');
		$m14 = $this->session->userdata('menu14');
		$m15 = $this->session->userdata('menu15');
		$m16 = $this->session->userdata('menu16');
		$m17 = $this->session->userdata('menu17');
		$m18 = $this->session->userdata('menu18');
		$m19 = $this->session->userdata('menu19');
		$m20 = $this->session->userdata('menu20');
		$m21 = $this->session->userdata('menu21');
		$k1 = $this->session->userdata('kec1');
		$k2 = $this->session->userdata('kec2');
		$k3 = $this->session->userdata('kec3');
		$k4 = $this->session->userdata('kec4');
		$k5 = $this->session->userdata('kec5');
		$k6 = $this->session->userdata('kec6');
		$k7 = $this->session->userdata('kec7');
		$k8 = $this->session->userdata('kec8');
		$k9 = $this->session->userdata('kec9');
		$k10 = $this->session->userdata('kec10');
		$k11 = $this->session->userdata('kec11');
		$k12 = $this->session->userdata('kec12');
		$k13 = $this->session->userdata('kec13');
		$k14 = $this->session->userdata('kec14');
		$k15 = $this->session->userdata('kec15');
		$k16 = $this->session->userdata('kec16');
		$k17 = $this->session->userdata('kec17');
		$k18 = $this->session->userdata('kec18');
		$k19 = $this->session->userdata('kec19');
		$k20 = $this->session->userdata('kec20');
		$k21 = $this->session->userdata('kec21');
		$k22 = $this->session->userdata('kec22');
		$k23 = $this->session->userdata('kec23');
		$k24 = $this->session->userdata('kec24');
		$k25 = $this->session->userdata('kec25');
		$k26 = $this->session->userdata('kec26');
		$k27 = $this->session->userdata('kec27');
		$k28 = $this->session->userdata('kec28');
		$k29 = $this->session->userdata('kec29');
		$k30 = $this->session->userdata('kec30');
		$k31 = $this->session->userdata('kec31');
		$k32 = $this->session->userdata('kec32');
		$k33 = $this->session->userdata('kec33');
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="<?php if($levelx!=1){echo 'disabled';} if($page=="Dashboard"){echo 'active';}?>">
                            <a href="<?= base_url('Dashboard'); ?>">
                                <i class="fa fa-dashboard"></i> <span>Dashboard</span>
                            </a>
                        </li>
						
						<li class="<?php if($m1==0){echo 'hidden';} if($page=="User"||$page=="Level"||$page=="Kecamatan"||$page=="Desa"||$page=="Master_agama"){echo 'active';}?> treeview">
                          <a href="#">
						...
						<li class="<?php if($m2==0){echo 'hidden';} if($page=="Perumahan"||$page=="Alatangkut"||$page=="Tps"||$page=="Malatangkut"||$page=="Alatangkutd"){echo 'active';}?> treeview">
                          <a href="#">
						...
						<li class="<?php if($m3==0){echo 'hidden';} if($page=="Perempuankk"||$page=="Pengaduanper"||$page=="Pengaduanank"||$page=="Pengaduanker"){echo 'active';}?> treeview">
                          <a href="#">
						...
						<li class="<?php if($m4==0){echo 'hidden';} if($page=="Jumlahphk"||$page=="Pencariantapend"||$page=="Pekerjaan_penduduk"){echo 'active';}?> treeview">
                          <a href="#">
						...
						<li class="<?php if($m5==0){echo 'hidden';} if($page=="Jenispengairan"){echo 'active';}?> treeview">
                          <a href="#">
						...
						<li class="<?php if($m6==0){echo 'hidden';} 
						if(
						...
						?> treeview">
                          ...
                          <li class="treeview <?php if($k1==0){echo 'hidden';} if($page=="Kec_jumlah_jenis_pelayanan_ampelgading"||$page=="Kec_prestasi_yang_diraih_ampelgading"||$page=="Kec_jumlah_aset_dihapus_ampelgading"||$page=="Kec_jumlah_pembinaan_ampelgading"||$page=="Kec_jumlah_aset_ampelgading"||$page=="Kec_wisata_lokal_ampelgading"||$page=="Kec_luas_wilayah_ampelgading"||$page=="Kec_jumlah_tempat_ibadah_ampelgading"||$page=="Ampelgading_struktur_pemerintahan"||$page=="Kec_banyak_lapangan_olahraga_ampelgading"||$page=="Kec_penduduk_berdasarkan_agama_ampelgading"||$page=="Kec_jamkesmas_ampelgading"){echo 'active';}?>">  
						  ...
						  <li class="treeview <?php if($k4==0){echo 'hidden';} if($page=="Kec_jumlah_jenis_pelayanan_dampit"||$page=="Kec_prestasi_yang_diraih_dampit"||$page=="Kec_jumlah_pembinaan_dampit"||$page=="Kec_jumlah_aset_dihapus_dampit"||$page=="Kec_jumlah_aset_dampit"||$page=="Kec_wisata_lokal_dampit"||$page=="Kec_luas_wilayah_dampit"||$page=="Kec_jumlah_tempat_ibadah_dampit"||$page=="Dampit_struktur_pemerintahan"||$page=="Kec_banyak_lapangan_olahraga_dampit"||$page=="Kec_penduduk_berdasarkan_agama_dampit"||$page=="Kec_jamkesmas_dampit"){echo 'active';}?>">  
						  ...
						  <li class="treeview <?php if($k12==0){echo 'hidden';} if($page=="Kec_jumlah_jenis_pelayanan_kasembon"||$page=="Kec_prestasi_yang_diraih_kasembon"||$page=="Kec_jumlah_pembinaan_kasembon"||$page=="Kec_jumlah_aset_dihapus_kasembon"||$page=="Kec_jumlah_aset_kasembon"||$page=="Kec_wisata_lokal_kasembon"||$page=="Kec_luas_wilayah_kasembon"||$page=="Kec_jumlah_tempat_ibadah_kasembon"||$page=="Kasembon_struktur_pemerintahan"||$page=="Kec_banyak_lapangan_olahraga_kasembon"||$page=="Kec_penduduk_berdasarkan_agama_kasembon"||$page=="Kec_jamkesmas_kasembon"){echo 'active';}?>">  
						  ...
						  <li class="treeview <?php if($k14==0){echo 'hidden';} if($page=="Kec_jumlah_jenis_pelayanan_kromengan"||$page=="Kec_prestasi_yang_diraih_kromengan"||$page=="Kec_jumlah_pembinaan_kromengan"||$page=="Kec_jumlah_aset_dihapus_kromengan"||$page=="Kec_jumlah_aset_kromengan"||$page=="Kec_wisata_lokal_kromengan"||$page=="Kec_luas_wilayah_kromengan"||$page=="Kec_jumlah_tempat_ibadah_kromengan"||$page=="Kromengan_struktur_pemerintahan"||$page=="Kec_banyak_lapangan_olahraga_kromengan"||$page=="Kec_penduduk_berdasarkan_agama_kromengan"||$page=="Kec_jamkesmas_kromengan"){echo 'active';}?>">  
						  ...
						  <li class="treeview <?php if($k17==0){echo 'hidden';} if($page=="Kec_jumlah_jenis_pelayanan_ngantang"||$page=="Kec_prestasi_yang_diraih_ngantang"||$page=="Kec_jumlah_pembinaan_ngantang"||$page=="Kec_jumlah_aset_dihapus_ngantang"||$page=="Kec_jumlah_aset_ngantang"||$page=="Kec_wisata_lokal_ngantang"||$page=="Kec_luas_wilayah_ngantang"||$page=="Kec_jumlah_tempat_ibadah_ngantang"||$page=="Ngantang_struktur_pemerintahan"||$page=="Kec_banyak_lapangan_olahraga_ngantang"||$page=="Kec_penduduk_berdasarkan_agama_ngantang"||$page=="Kec_jamkesmas_ngantang"){echo 'active';}?>">  
						  ...
						  <li class="treeview <?php if($k21==0){echo 'hidden';} if($page=="Kec_jumlah_jenis_pelayanan_pakisaji"||$page=="Kec_prestasi_yang_diraih_pakisaji"||$page=="Kec_jumlah_pembinaan_pakisaji"||$page=="Kec_jumlah_aset_dihapus_pakisaji"||$page=="Kec_jumlah_aset_pakisaji"||$page=="Kec_wisata_lokal_pakisaji"||$page=="Kec_luas_wilayah_pakisaji"||$page=="Kec_jumlah_tempat_ibadah_pakisaji"||$page=="Pakisaji_struktur_pemerintahan"||$page=="Kec_banyak_lapangan_olahraga_pakisaji"||$page=="Kec_penduduk_berdasarkan_agama_pakisaji"||$page=="Kec_jamkesmas_pakisaji"){echo 'active';}?>">  
						  ...
						  <li class="treeview <?php if($k27==0){echo 'hidden';} if($page=="Kec_jumlah_jenis_pelayanan_tajinan"||$page=="Kec_prestasi_yang_diraih_tajinan"||$page=="Kec_jumlah_pembinaan_tajinan"||$page=="Kec_jumlah_aset_dihapus_tajinan"||$page=="Kec_jumlah_aset_tajinan"||$page=="Kec_luas_wilayah_tajinan"||$page=="Kec_jumlah_tempat_ibadah_tajinan"||$page=="Tajinan_struktur_pemerintahan"||$page=="Kec_banyak_lapangan_olahraga_tajinan"||$page=="Kec_penduduk_berdasarkan_agama_tajinan"||$page=="Kec_jamkesmas_tajinan"){echo 'active';}?>">  
						  ...
						  <li class="treeview <?php if($k28==0){echo 'hidden';} if($page=="Kec_jumlah_jenis_pelayanan_tirtoyudo"||$page=="Kec_prestasi_yang_diraih_tirtoyudo"||$page=="Kec_jumlah_pembinaan_tirtoyudo"||$page=="Kec_jumlah_aset_dihapus_tirtoyudo"||$page=="Kec_jumlah_aset_tirtoyudo"||$page=="Kec_wisata_lokal_tirtoyudo"||$page=="Kec_luas_wilayah_tirtoyudo"||$page=="Kec_jumlah_tempat_ibadah_tirtoyudo"||$page=="Tirtoyudo_struktur_pemerintahan"||$page=="Kec_banyak_lapangan_olahraga_tirtoyudo"||$page=="Kec_penduduk_berdasarkan_agama_tirtoyudo"||$page=="Kec_jamkesmas_tirtoyudo"){echo 'active';}?>">  
                        ...
                        <li class="<?php if($m7==0){echo 'hidden';} if($page=="InputBencana"||$page=="Sarana"||$page=="Kebakaran"||$page=="Bencana"||$page=="Pemadam"||$page=="Pamongpraja"||$page=="JenisKorban"||$page=="Banyakbencana"||$page=="Unjukrasa"){echo 'active';}?> treeview">
                          <a href="#">
						...
						<li class="<?php if($m8==0){echo 'hidden';} if($page=="Diztribusi"||$page=="InputBibit"||$page=="Lokasi_pencemaran"||$page=="Perusahaan_limbah"){echo 'active';}?> treeview">
                          <a href="#">
                        ...
                        <li class="<?php if($m9==0){echo 'hidden';} if($page=="InputTerminal"||$page=="Lokasi_terminal"||$page=="Banyakkendaraan"||$page=="Penumpangangkutan"){echo 'active';}?> treeview">
                          <a href="#">
                         ...
                         <li class="<?php if($m10==0){echo 'hidden';} if($page=="LembagaMasyarakat"||$page=="KelompokEkonomi"){echo 'active';}?> treeview">
                          <a href="#">
						...
						<li class="<?php if($m11==0){echo 'hidden';} if($page=="Negara"||$page=="Pasar_tradisional"||$page=="Pasar_modern"||$page=="Sarana_perdagangan"||$page=="Ekspor_komoditi"||$page=="Ekspor_negara_tujuan"||$page=="Impor_negara_asal"){echo 'active';}?> treeview">
                          <a href="#">
                        ...
                        <li class="<?php if($m12==0){echo 'hidden';} if($page=="C_master_bidang"||$page=="Jenis_industri"||$page=="Komoditi"||$page=="Klasifikasi"||$page=="Industri_kecil"||$page=="Industri_rumah_tangga"||$page=="Investasi_pmdn"||$page=="Banding_kembang_realisasi_ekspor"||$page=="Perusahaan_klasifikasi"){echo 'active';}?> treeview">
                          <a href="#">
                        ...
                        <li class="<?php if($m13==0){echo 'hidden';} if($page=="Provinsi"||$page=="Transmigrasi"){echo 'active';}?> treeview">
                          <a href="#">
						...
						<li class="<?php if($m14==0){echo 'hidden';} if($page=="C_master_perda"||$page=="C_master_provider"||$page=="C_master_kerjasama"||$page=="C_master_negara"||$page=="C_kominfo"||$page=="C_kerjasama_media"||$page=="C_twr"||$page=="C_apl"||$page=="C_pengunjung_negara"||$page=="internetkecamatan"||$page=="internetrumahsakit"){echo 'active';}?> treeview">
                          <a href="#">
                        ...
                        <li class="<?php if($m15==0){echo 'hidden';} if($page=="C_penanaman"||$page=="C_penanaman/perkembangan"){echo 'active';}?> treeview">
                          <a href="#">
                        ...
                        <li class="<?php if($m16==0){echo 'hidden';} if($page=="C_cabangolah"||$page=="C_prasarana"||$page=="C_master_cabangolahraga"){echo 'active';}?> treeview">
                            <a href="#">
						...
						<li class="<?php if($m17==0){echo 'hidden';} if($page=="C_potensi_unggulan"||$page=="C_wisatawan"||$page=="C_wisatawan_menginap"||$page=="C_desa_wisata"||$page=="C_wisata_buatan"||$page=="C_wisata_alam"||$page=="C_wisata_budaya"||$page=="C_warisan_budaya"){echo 'active';}?> treeview">
                          <a href="#">
                        ...
                        <li class="<?php if($m18==0){echo 'hidden';} if($page=="C_ternak_dipotong"||$page=="C_master_unggas"||$page=="C_master_hewan_ternak"||$page=="C_master_susu"||$page=="C_produksi_telur"||$page=="C_master_daging"||$page=="C_produksi_susu"||$page=="C_vaksinasi_avian"||$page=="C_usaha_peternakan"||$page=="C_produksi_daging"){echo 'active';}?> treeview">
                          <a href="#">
                        ...
                        <li class="<?php if($m19==0){echo 'hidden';} if($page=="C_pelanggan_pdam"||$page=="C_volume_air_minum_pdam"){echo 'active';}?> treeview">
                          <a href="#">
						...
						<li class="<?php if($m20==0){echo 'hidden';} if($page=="master_tajukbuku"||$page=="jumlahkoleksibuku"||$page=="pengunjungperpusjkel"||$page=="pengunjungperpustpend"||$page=="pengunjungperpusspekerjaan"){echo 'active';}?> treeview">
                          <a href="#">
                    ...
                    <li class="<?php if($m21==0){echo 'hidden';} if($page=="Produksiperikanan"||$page=="produksiikan"||$page=="master_semuaikan"){echo 'active';}?> treeview">
                          <a href="#">
