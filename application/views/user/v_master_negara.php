<body>
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                <b>Kelola Data Negara<b>
                        <small>KABUPATEN MALANG SATU DATA</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="<?= base_url('Dashboard'); ?>"><i class="fa fa-home"></i> Home</a></li>
                <li class="active">Data Negara</li>
            </ol>
        </section>
        <!-- Main content -->
        <section class="content">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Tabel Data Negara</h3>
                </div>
                <div class="box-body">
                    <a class="btn btn-primary" href="#modalAdd" data-toggle="modal" title="Add">Tambah Data Master Negara</a>
                    <br><br>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h3 class="modal-title" id="myModalLabel">Update Data Negara</h3>
                                    </div>
                                    <?php echo form_open_multipart('C_master_negara/proses_edit_master_negara') ?>

                                    <div class="modal-body">
                                        <input class="form-control" type="hidden" name="id" value="<?php echo $id; ?>" placeholder="Id..." style="width:335px;" readonly hidden>
                                        <table>
                                            <tr>
                                                <td><label>Nama Media</label></td>
                                                <td>:</td>
                        ...
                        <div id="modalHapus<?php echo $id ?>" class="modal modal" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <?php echo form_open_multipart('C_master_negara/proses_delete_master_negara') ?>
                                    <div class="modal-body">
                    ...
                    <div id="modalAdd" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <?php echo form_open_multipart('C_master_negara/proses_input_master_negara') ?>
