				...
				<div class="col-xs-12">
					...
					<div class="box">
						...
						<div class="box-header">
							<h4 class="box-title" style="margin-bottom:10px ">Wisatawan Datang Ke Kabupaten Malang</h3><br>
								<div>
									<tr>
										<td>
											<a class="btn btn-primary" href="#modalAdd" data-toggle="modal" title="Add">Tambah Data</a>
											<a class="btn btn-danger" href="#modalCross" data-toggle="modal">Tampil Report</a>
							...
							<div id="modalAdd" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<?php echo form_open_multipart('C_wisatawan/proses_tambah_wisatawan') ?>
										...
										<div class="modal-body">
											...
											<table>
												...
												<tr>
													...
													<td>:</td>
													<td><select multiple name="jenis_wisatawan" style="width:335px;" id="jenis_wisatawan" class="form-control" required>
							...
							<div id="modalCross" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<?php echo form_open_multipart(base_url('C_wisatawan/tampil_crosstab_datang')) ?>
										<div class="modal-body">
											<table>
							...
							<div id="modalgrafik" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<?php echo form_open_multipart('C_wisatawan/grafik_perbandingan') ?>
										<div class="modal-body">
											<table>
												<tr>
	...
	var tp1 = $('#tampilDatang').DataTable({
		...
		buttons: [{
			...
			},
			{
				extend: 'pdf',
				footer: true,
				className: 'btn btn-sm btn-danger down',
				exportOptions: {
					columns: ':visible'
				}
			},
			{
				extend: 'print',
				footer: true,
				className: 'btn btn-sm btn-success down',
				exportOptions: {
					columns: ':visible'
				}
			},
			{
				extend: 'colvis',
				footer: true,
				className: 'btn btn-sm btn-primary down'
			},
		],
		"language": {
			"url": "<?php echo base_url(); ?>assets/bhs_indo/bahasa.json"
		},
		"ajax": 'C_wisatawan/get'
	});

	$("#tahun").change(function() {
		end = this.value;
		console.log(end);
		tp1.ajax.url('C_wisatawan/get?tahun=' + end).load();
	});
</script>
<!--
